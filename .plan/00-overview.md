...
**01 → 02 → 03 → 04 → 05 → 06** forms the critical path. All extensions build on this.

Steps 07 and 08 are independent and can be developed in parallel once 02 is done.
Steps 10–12 can begin after 06 is solid.
Steps 14–15 are last — they require a complete route registry.
